  ...
  return (
    <div className='w-screen flex flex-col items-center justify-center'>
      ...
      <div className="w-full max-w-4xl px-4">
        <div className="">
          <Link href="https://drive.google.com/file/d/109tZvWyrBcM-_kmNJXQD-kacFbiH9UUd/view?usp=sharing"><button className="py-3 px-8 font-semibold bg-slate-200 shadow-md rounded-3xl text-slate-700">Resume</button></Link>
        </div>
      </div>
    </div>
  )
